...
#ifndef DELEGATEFILTERITEM_H
#define DELEGATEFILTERITEM_H

#include <QStyledItemDelegate>

class DelegateFilterItem : public QStyledItemDelegate
{
public:
	DelegateFilterItem(QObject *parent = 0);

	// reimplement QStyledItemDelegate
